...
From the confusion matrix, the accuracy rate is 0.873 so the classification tree does predict our outcome of interest, classe, fairly well.
...
From the confusion matrix, the accuracy rate is 0.999 so the random forest method does predict our outcome of interest, classe, very well.
